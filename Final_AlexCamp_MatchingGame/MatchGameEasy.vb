...
Public Class frmMatchingGameEasy
    Private decClickValue As Decimal = 1.5
    ...
    Private icons =
        New List(Of String) From {"b", "b", "k", "k", "N", "N",
                                "j", "j", "w", "w", "F", "F"}
    ...
    Private Sub frmMatchingGameEasy_FormClosed(sender As Object, e As FormClosedEventArgs) Handles MyBase.FormClosed
    ...
    Private Sub frmMatchingGameEasy_Load(sender As Object, e As EventArgs) Handles MyBase.Load
