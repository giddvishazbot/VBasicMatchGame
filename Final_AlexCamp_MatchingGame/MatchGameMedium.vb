...
Public Class frmMatchingGameMedium
    Private decClickValue As Decimal = 1.0
    ...
    Private icons =
        New List(Of String) From {"b", "b", "k", "k", "N", "N", "u", "u",
                                "j", "j", "w", "w", "F", "F", "D", "D"}
    ...
    Private Sub frmMatchingGameMedium_FormClosed(sender As Object, e As FormClosedEventArgs) Handles MyBase.FormClosed
    ...
    Private Sub frmMatchingGameMedium_Load(sender As Object, e As EventArgs) Handles MyBase.Load
